...
xst -ifn xst.scr
move xilinx_pcie_1_1_ep_s6.ngc .\results\PCIe_IP_top.ngc

cd results

echo 'Running ngdbuild'
ngdbuild -verbose -uc ..\..\example_design\xilinx_pcie_1_lane_ep_xc6slx25t-csg324-2.ucf PCIe_IP_top.ngc
echo 'Running map'
map -o mapped.ncd PCIe_IP_top.ngd mapped.pcf
